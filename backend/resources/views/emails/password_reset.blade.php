...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f5; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <p style="color: #3f3f46; font-size: 16px;">Has solicitado restablecer tu contraseña. Este es tu código de verificación:</p>

        <div style="background-color: #f4f4f5; padding: 15px; text-align: center; border-radius: 6px; margin: 20px 0;">
            <span style="font-size: 24px; font-weight: bold; color: #18181b; letter-spacing: 2px;">{{ $code }}</span>
        </div>

        <p style="color: #3f3f46; font-size: 16px;">Ingresa este código en la app para continuar. Es válido durante 15 minutos y solo puede usarse una vez; después deberás crear tu nueva contraseña.</p>
